...
@Repository
public class IncomeCertRepositoryImpl implements IncomeCertRepository{
    private EntityManagerFactory emf= Persistence.createEntityManagerFactory("poojitha");
    @Override
    public Boolean save(IncomeCertificateEntity incomeCertificateEntity) {
        EntityManager entityManager = emf.createEntityManager();
        try {
            entityManager.getTransaction().begin();
            entityManager.persist(incomeCertificateEntity);
    ...
    @Override
    public List<IncomeCertificateEntity> getAllApplicantInfo() {
        EntityManager entityManager= emf.createEntityManager();
