...
@Repository
public class AadharApplyRepositoryImpl implements AadharApplyRepository{
    private EntityManagerFactory emf= Persistence.createEntityManagerFactory("poojitha");

    @Override
    public Boolean save(AadharApplyEntity aadharApplyEntity) {
        EntityManager entityManager = emf.createEntityManager();
        try {
            entityManager.getTransaction().begin();
            entityManager.persist(aadharApplyEntity);
    ...
    @Override
    public List<AadharApplyEntity> getAllApplicantInfo() {
        EntityManager entityManager= emf.createEntityManager();
