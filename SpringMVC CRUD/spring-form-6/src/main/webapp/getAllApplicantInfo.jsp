...
<body>
<h1 class="head">AADHAR APPLICANT INFO</h1>
<table>
    <tr>
        <th>SL NO</th>
        <th>Full Name</th>
    ...
    <poo:forEach items="${ListOfApplicants}" var="applicantInfo">
        <tr>
            ...
            <td>${applicantInfo.getFullName()}</td>
            ...
            <td>${applicantInfo.getFatherName()}</td>
            <td>${applicantInfo.getMotherName()}</td>
            <td><a href="delete?id=${applicantInfo.getId()}"><i class="material-icons">delete</i></a>&nbsp;
            <a href="getApplicant?id=${applicantInfo.getId()}"><i class="material-icons">edit</i></a></td>
        </tr>
    </poo:forEach>
</table>
</body>
